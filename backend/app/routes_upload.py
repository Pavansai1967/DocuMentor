...
async def run_ingestion(document_id: ObjectId, data: bytes, store: MongoStore, embedder: Embedder) -> None:
    try:
        ...
        await asyncio.to_thread(store.mark_document_ready, document_id, page_count)
...
async def upload_pdf(
    ...
    background.add_task(run_ingestion, document_id, data, store, embedder)
